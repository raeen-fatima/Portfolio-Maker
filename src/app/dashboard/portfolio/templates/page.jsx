...
// import TemplateCard from "@/components/portfolio/templates/TemplateCard";
...
export default function TemplatesClient({ portfolio }) {
  ...
  return (
    <div ref={containerRef} className="mx-auto max-w-7xl space-y-10 p-6 lg:p-10">
      {/* Header */}
      <div className="template-animate">
        <BuilderHeader
          title="Choose Template"
          description="Select a template that matches your personality and professional brand."
          step={8}
      ...
      {/* Templates */}
      <section className="template-animate">
        <div className="mb-8">
          <h2
            className="
              text-2xl
