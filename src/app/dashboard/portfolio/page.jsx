...
export default function PortfolioBuilderPage() {
  ...
  useGSAP(
    () => {
      if (!loading && dashboard && containerRef.current) {
        // Stagger entrance animation for section cards
        gsap.from(".builder-animate", {
          y: 20,
          opacity: 0,
          duration: 0.5,
          stagger: 0.08,
    ...
    { dependencies: [loading, dashboard], scope: containerRef }
  );
    ...
    <div ref={containerRef} className="space-y-8">
      ...
      >
        ...
        >
          ...
          <div>
            <p className="text-zinc-500">Portfolio Score</p>

            <h2 className="mt-2 text-5xl font-bold">{dashboard.score}</h2>
          </div>

          <div>
            <p className="text-zinc-500">Views</p>

            <h2 className="mt-2 text-5xl font-bold">{dashboard.views}</h2>
          </div>
        </div>
      ...
      >
        ...
        <div
          ...
          "
        >
          <h2 className="text-xl font-semibold">Builder Roadmap</h2>
      ...
      <div
        ...
        "
      >
        <h2 className="text-2xl font-semibold">Continue Building</h2>

        <p className="mt-2 text-zinc-500">
          Complete the remaining sections to improve your portfolio score and get
