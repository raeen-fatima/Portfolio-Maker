...
export default function AboutPage() {
  ...
  useGSAP(
    () => {
      if (containerRef.current) {
        gsap.from(".about-builder-animate", {
          y: 20,
          opacity: 0,
          duration: 0.5,
          stagger: 0.08,
  ...
  return (
    <div ref={containerRef} className="space-y-6 p-6 lg:p-12">
      {/* Header */}
      <div className="about-builder-animate">
        <BuilderHeader
          title="About Section"
          description="Tell visitors more about yourself, your background, and how they can contact you."
          step={2}
      ...
      >
        ...
        >
          ...
          <p className="mt-4 text-zinc-300 leading-relaxed text-center sm:text-left">
            {bio ||
              "Your bio will appear here. Tell visitors about yourself, your background, interests, and professional journey."}
          </p>
