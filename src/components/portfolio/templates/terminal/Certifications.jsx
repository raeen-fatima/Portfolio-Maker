...
export default function Certifications({ certifications }) {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        <div className="cert-terminal-box overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-950 shadow-2xl">
          {/* Header */}
          ...
          <div className="p-8 font-mono md:p-12">
            <p className="text-green-500">$ ls certificates/</p>
              ...
              {certifications.map((certificate, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-green-400 break-all font-semibold">
                      {certificate.title
                        ?.toLowerCase()
                        .replaceAll(" ", "-")}
                      .pdf
