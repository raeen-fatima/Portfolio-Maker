...
export default function Education({ education }) {
  ...
  useGSAP(
    () => {
      ...
      tl.fromTo(
        ...
        // Vertical Timeline Line Draw Animation
        .fromTo(
          ".edu-line",
          { scaleY: 0 },
          {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-24">
        {/* Header */}
        <div className="edu-header max-w-2xl">
          ...
          <p className="mt-6 text-lg leading-8 text-zinc-500">
            My educational background and the foundation that shaped my
            skills, knowledge, and growth.
          </p>
        </div>
        ...
        <div className="relative mt-20">
          {/* Vertical Line */}
          <div className="edu-line absolute left-1.75 top-0 h-full w-px bg-zinc-200" />

          <div className="space-y-16">
            {education.map((item) => (
              <div key={item._id} className="edu-item relative pl-12">
                {/* Dot */}
                <div
                  className="
                    absolute
