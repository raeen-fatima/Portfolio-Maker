...
export default function Projects({ projects }) {
  ...
  useGSAP(
    () => {
      ...
      // Individual Project Card Scroll Animations
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-24">
        {/* Header */}
        <div className="projects-header max-w-2xl">
        ...
        <div className="mt-20 space-y-24">
          {projects.map((project, index) => (
            <div
              key={project._id}
              className="project-item grid gap-10 border-t border-zinc-200 pt-12 lg:grid-cols-2"
            >
              {/* Image */}
              <div>
                {project.image && (
                  <div className="relative overflow-hidden rounded-3xl border border-zinc-200">
                    <Image
                      ...
                      width={800}
                      height={600}
                      className="h-75 w-full object-cover transition duration-700 hover:scale-105"
                    />
                  </div>
                )}
              </div>
                ...
                <div className="mt-10 flex flex-wrap gap-6">
                  {project.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 font-medium text-black transition hover:text-lime-500"
                    >
                      <FaGithub size={18} />
                      GitHub
                    </a>
