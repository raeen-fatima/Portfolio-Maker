...
export default function Skills({ skills }) {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-24">
        {/* Header */}
        <div className="skills-header max-w-2xl">
        ...
        <div className="mt-16 grid gap-12 md:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Decorative Block - Focus */}
          <div className="skills-col rounded-3xl border border-zinc-200 p-8 shadow-2xs">
            ...
            <p className="mt-4 leading-7 text-zinc-600">
              Passionate about creating modern, performant and user-friendly
              digital experiences.
            </p>
          </div>

          {/* Decorative Block - Learning */}
          <div className="skills-col rounded-3xl border border-zinc-200 p-8 shadow-2xs">
            <p className="text-xs font-semibold uppercase tracking-wider text-zinc-500">
              Learning
            </p>
            ...
            <p className="mt-4 leading-7 text-zinc-600">
              Continuously improving through projects, experimentation and
              real-world problem solving.
            </p>
          </div>
        </div>
