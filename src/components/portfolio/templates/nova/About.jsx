        ...
        <div className="grid items-start gap-16 lg:grid-cols-2">
          ...
          <div className="about-image-card">
            {aboutData?.image ? (
              ...
              <div className="h-[420px] rounded-3xl border border-zinc-800 bg-zinc-900/40" />
            )}
          </div>
          ...
          <div className="about-content">
            ...
            {(aboutData?.github ||
              aboutData?.linkedin ||
              aboutData?.instagram) && (
              <div className="about-socials mt-10">
                <p className="mb-4 text-xs uppercase tracking-[0.3em] text-zinc-500 font-semibold">
                  Connect With Me
                </p>
