    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-20 lg:py-28">
        ...
        <div className="exp-header mb-16">
          ...
          <p className="mt-4 max-w-2xl text-zinc-400">
            My experience across internships, freelance projects, and
            professional roles.
          </p>
        </div>
        ...
        {/* Timeline */}
        <div className="relative">
          <div className="exp-timeline-line absolute left-3.75 top-0 h-full w-px bg-zinc-800" />

          <div className="space-y-10">
            {experiences.map((experience, index) => (
              <div
                key={experience._id || index}
                className="exp-item relative pl-12"
              >
                {/* Dot */}
                <div
                  className="
