...
export default function Hero({ heroData, socialLinks }) {
    ...
    <section ref={containerRef} id="hero" className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div>
            {/* Badge */}
            <div className="hero-content-animate inline-flex items-center rounded-full border border-violet-500/20 bg-violet-500/10 px-4 py-2 text-sm font-medium text-violet-300 mb-6">
              Available For Work ✨
            </div>

            {/* Intro */}
            <p className="hero-content-animate text-zinc-400 text-lg mb-4">
              Hey, I&apos;m 👋
            </p>
            ...
            >
              ...
              <span className="block text-white md:text-4xl lg:text-5xl">
                {titleWords.slice(1).join(" ") || "Developer"}
              </span>
            </h1>
            ...
            {/* Buttons */}
            <div className="hero-content-animate mt-10 flex flex-wrap gap-4">
              <a
                href="#contact"
                className="
                  rounded-xl
            ...
            {(socialLinks?.github || socialLinks?.linkedin || socialLinks?.twitter) && (
              <div className="hero-content-animate mt-8 flex items-center gap-5">
                {socialLinks?.github && (
                  <Link
                    href={socialLinks.github}
                    target="_blank"
          ...
          {/* RIGHT IMAGE */}
          <div className="hero-image-animate flex justify-center lg:justify-end">
            <div className="relative">
              {/* Outer Ring */}
              <div
                className="
